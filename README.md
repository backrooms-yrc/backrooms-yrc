...
你好，我是 Rcst20（RuochenYang）。这份 README 是我的个人介绍页：一个喜欢折腾服务器、写代码和做小项目的学生的自述。

用户名的小故事：这个账号从小学时期就创建了，当时随手起了个名字，现在很多链接都指向它，干脆就不改了，留作纪念啦 😄
...
- 🎓 学生（初中），热爱编程与动手实践
- 💻 喜欢后端、服务器部署、自动化与小工具开发
- 🎯 目标：写出既实用又有趣的代码，做出好看且可用的项目
...
> 注：我一直在学习中，工具与语言会随项目需求变化。

---

## 🧾 项目与作品

- 这里放的是我在 GitHub 上的一些仓库（从小练手到较完整的小项目）。
- 想看我的项目或合作请访问我的主页： [backrooms-yrc](https://github.com/backrooms-yrc)

（如果你愿意，我可以帮你把 README 自动列出仓库摘要或展示精选项目。）
...
如果你想交流技术、提出建议或有合作想法，欢迎通过上述方式联系我。
